...
if (isset($_GET['ultimate_id'])) {
    $completa = $inicio->getById($_GET['ultimate_id']);
...
<div class="d-flex justify-content-center margin-top-1 margin-left-5">
    <div class="fadeInDown">
        <div id="formContent">
            
        <h3 class="margin-top-4 text-center text-dark"><strong>Elecciones</strong></h3>
        
        <div class="fadeIn first">
            <img src="../../assets/Img/Almacenamiento/votar.png" class="icon" alt="User Icon"/></div>
            
        <form action="Iniciar.php" method="POST">
            <input type="text" class="input-space margin-top-2" id="documento" class="fadeIn second" name="nombre"required placeholder="Ingrese el nombre de la elección">
